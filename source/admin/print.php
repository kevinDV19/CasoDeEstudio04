...
<html>
	<head>
		<meta charset="utf-8">
		<title>HOTEL AS DE OROS Factura</title>
...
@page { margin: 0; }
	...
	?>
		...
		<article>
		  <h1>Recipient</h1>
			...
			<table class="inventory">
				...
				<tbody>
					<tr>
						<td><span >Tipo de habitación: <?php echo $troom; ?></span></td>
					...
					<tr>
						<td><span >Tipo de cama: <?php echo $bed; ?></span></td>
						<td><span ><?php echo $days; ?></span></td>
					...
					<tr>
						<td><span >Tipo de servicio: <?php echo $meal; ?>  </span></td>
						<td><span ><?php echo $days; ?></span></td>
		...
		<aside>
			...
			<div >
				<p align="center">Correo :- info@hotelasdeoros.com || Web :- www.asdeoros.com || Teléfono :- +52 32 72 74 03 37</p>
			</div>
		</aside>
	</body>
</html>
