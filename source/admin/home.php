...
<head>
    ...
    <title>HOTEL AS DE OROS ADMINISTRADOR</title>
    <!-- Bootstrap Styles-->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="settings.php"><i class="fa fa-bar-chart-o"></i> Libro de habitaciones</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="reservation.php"><i class="fa fa-bar-chart-o"></i>Reservar</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Estado <small>Libro de reservaciones </small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
                    ...
                    <div class="panel panel-default">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-default" type="button">
												 Nuevas solicitudes de reserva<span class="badge"><?php echo $c ; ?></span>
											</button>
											</a>
                                        </h4>
                                    </div>
									...
									{	
										...
										if($co=="Not Conform")
										{
											echo"<tr>
												...
												<th><a href='roombook.php?rid=".$trow['id']." ' class='btn btn-primary'>Aceptar</a></th>
												</tr>";
										}	
                      ...
                      <!-- End  Basic Table  --> 
                                ...
                                <div class="panel panel-info">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-primary" type="button">Habitaciones reservadas<span class="badge"><?php echo $r ; ?></span>
											</button>
                            ...
                            <div class="table-responsive">
								...
								<a href="messages.php" class="btn btn-primary">Más Acciones</a>
                            </div>
                        </div>
                    </div>
                                        </div>
                                ...
                                <div class='modal-dialog'>
                                    <div class='modal-content'>
                                        <div class='modal-header'>
                                            ...
                                            <h4 class='modal-title' id='myModalLabel'>Cambiar nombre de usuario y contraseña</h4>
                                        </div>
										<form method='post>
