        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="settings.php"><i class="fa fa-dashboard"></i>Estado de habitaciones</a>
                    </li>
					<li>
                        <a   href="room.php"><i class="fa fa-plus-circle"></i>Añadir habitación</a>
                    </li>
                    <li>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">Eliminar habitación</div>
                        <div class="panel-body">
						<form name="form" method="post">
                            <div class="form-group">
                                            <label>Selecciona el ID de la habitación*</label>
							 ...
							 <input type="submit" name="del" value="Eliminar Habitación" class="btn btn-primary"> 
							</form>
							<?php
							 include('db.php');
