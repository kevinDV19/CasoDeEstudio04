...
<head>
    ...
    <title>HOTEL CITY Administrador	</title>
    <!-- Bootstrap Styles-->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="messages.php"><i class="fa fa-desktop"></i> Enviar correos</a>
                    </li>
					<li>
                        <a class="active-menu" href="roombook.php"><i class="fa fa-bar-chart-o"></i> Libro de habitaciones</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Libro de habitaciones<small>	<?php echo  $curdate; ?> </small>
                        </h1>
                    </div>
                        ...
                        <div class="panel-footer">
                            <form method="post">
										<div class="form-group">
														<label>Selecciona la conformación</label>
														<select name="conf"class="form-control">
															<option value selected>	</option>
															<option value="Conform">Conformación</option>
