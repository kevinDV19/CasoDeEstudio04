...
<head>
    ...
    <title>HOTEL AS DE OROS MENU</title>
	<!-- Bootstrap Styles-->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="settings.php"><i class="fa fa-dashboard"></i>Estado de habitaciones</a></li>
					<li>
                        <a  class="active-menu" href="room.php"><i class="fa fa-plus-circle"></i>Añadir habitación</a>
                    </li>
                    <li>
                        <a  href="roomdel.php"><i class="fa fa-desktop"></i> Eliminar habitación</a></li>
        ...
        <div id="page-wrapper" >
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            INFORMACIÓN DE HABITACIONES</div>
                        <div class="panel-body">
								<!-- Advanced Tables -->
